...
class TendopayConfirmationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        if ($order_id && ($secure_key == $customer->secure_key)) {
            ...
            $redUrl =  $cart_id . '&id_module=' . $module_id . '&id_order=' . $order_id . '&key=' . $secure_key;

            Tools::redirect('index.php?controller=order-confirmation&id_cart=' .$redUrl);
        } else {
            /*
             * An error occured and is shown on a new page.
             */
            $errorText = 'An error occured. Please contact the merchant to have more informations';
            $this->errors[] = $this->module->l($errorText);
